...
public class DefaultExecutor implements Executor {
	 ...
	 * into our <code>System.out</code> and <code>System.err</code> to avoid a
	 * blocked or deadlocked subprocess (see{@link java.lang.Process Process}).
	 */
	...
	public int execute(final CommandLine command,
			Map<String, String> environment) throws ExecuteException,
			IOException {
		...
		Runnable runnable = new Runnable() {
			public void run() {
				...
				try {
					...
					handler.onProcessFailed(new ExecuteException(
							"Execution failed", exitValue, e));
				}
			}
		};
	 ...
	 * @throws IOException
	 *             closing one of the three streams failed
	 */
