...
public interface Executor {
	...
	/**
	 * Checks whether <code>exitValue</code> signals a failure. If no exit
	 * values are set than the default conventions of the OS is used. e.g. most
	 * OS regard an exit code of '0' as successful execution and everything else
	 * as failure.
	 * 
	 * @param exitValue
